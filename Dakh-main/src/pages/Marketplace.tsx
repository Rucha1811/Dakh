            ...
            >
              ...
              <div className="h-52 w-full relative overflow-hidden bg-gray-100 dark:bg-gray-800">
                ...
                {product.exportStatus === 'READY' && (
                  <span className="absolute top-3 right-3 inline-flex items-center gap-1 bg-[var(--color-success)] text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-sm z-10">
                    <BadgeCheck className="w-3 h-3" />
                    Export Ready
                  </span>
                )}
                {product.destinationCountry && (
                  <span className="absolute top-3 left-3 text-lg z-10 bg-white/80 dark:bg-gray-900/80 px-1.5 py-0.5 rounded-lg shadow-xs" title={product.destinationCountry}>
